...
export const BaseTemplate = (props: {
  ...
  return (
    <div className="min-h-screen antialiased" style={{ backgroundColor: BG, color: '#111' }}>
      ...
      <footer
        className="border-t border-gray-200 px-4 pt-12 sm:px-6"
      ...
      >
        <div className="mx-auto max-w-6xl">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 border-t border-gray-200 py-6 text-xs text-gray-400">
            ...
            <div className="flex flex-wrap gap-3">
              {['Status', 'Security', 'Imprint', 'Terms of service', 'Privacy policy', 'Cookie policy'].map(
                item => (
                  <Link key={item} href="/about/" className="transition-colors hover:text-gray-700">
                    {item}
                  </Link>
                ),
              )}
